...
- Destination-first delivery cards with customer phone access and a fixed ride-status action
...
- Presentation-friendly mock logout that restores all sample deliveries and the Start Ride state
